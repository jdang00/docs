...
Manual questions can cite a processed Content Library document and the pages that support the rationale. Citations are optional. They give students and future editors a direct path back to the course material.

See [Manual source citations](/contributors/manual-source-citations) for the full workflow.
