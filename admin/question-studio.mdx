...
<Note>
For the updated Pages/Topics flow and context meter, see [Source context](/admin/source-context). That flow is currently in development; the controls below describe the earlier workflow.
</Note>
